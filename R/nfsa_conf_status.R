...
nfsa_conf_status <- function(table = "T0801",
  ...
  cli::cli_alert_success(paste0("File created in ", output_sel,"/output/flags/",as.character(format(Sys.time(), "%Y%m%d_%H%M%S")),"_conf_status_T0800_new.xlsx"))
...
cli::cli_alert_success(paste0("File created in ", output_sel,"/output/flags/",as.character(format(Sys.time(), "%Y%m%d_%H%M%S")),"_conf_status_T0800_prev.xlsx"))
  ...
  cli::cli_alert_success(paste0("File created in ", output_sel,"/output/flags/",as.character(format(Sys.time(), "%Y%m%d_%H%M%S")),"_conf_status_T0801_new.xlsx"))
  ...
  cli::cli_alert_success(paste0("File created in ", output_sel,"/output/flags/",as.character(format(Sys.time(), "%Y%m%d_%H%M%S")),"_conf_status_T0801_prev.xlsx"))
    ...
    cli::cli_alert_success(paste0("File created in ", output_sel,"/output/flags/",as.character(format(Sys.time(), "%Y%m%d_%H%M%S")),"_conf_status_T0801SA_new.xlsx"))
    ...
    cli::cli_alert_success(paste0("File created in ", output_sel,"/output/flags/",as.character(format(Sys.time(), "%Y%m%d_%H%M%S")),"_conf_status_T0801SA_prev.xlsx"))
  }
  return(l)
}
