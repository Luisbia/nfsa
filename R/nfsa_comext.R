...
#'   data for a specified area (EA21 or EU27) and quarter.
#'
#' @param area A string indicating the geographical area ("EA21" or "EU27").
...
#'   historical data file: "EA21_lines to add.csv" for EA21 or "EU27_lines to add.csv" for EU27.
#'
...
#' nfsa_comext(area = "EA21", quarter = "2025Q4", output_sel = "path/to/output/")
#'
...
nfsa_comext <- function(area,
                             quarter,
                             output_sel,
                             input_sel = "M:/nas/QSA10/Production/2026Q1/(1) QSA/(1_1) Original transmission/(1_1_2) Other input/Comext/") {
