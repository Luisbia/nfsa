...
nfsa_internal_consistency_T0801 <- function(dataset,
  ...
  needed_s1ss06 <- c("ref_area", "sto", "time_period", "S11", "S12", "S1")
  ...
  if (nrow(sit01) > 0) check_results$SIT01 <- s1t01
  ## SIT02----------------------------------------------------------------------------------------
  ...
  if (nrow(sit02) > 0) check_results$SIT02 <- s1t02
  ...
  if (nrow(sit03) > 0) check_results$SIT03 <- s1t03
  ...
  if (nrow(sit04) > 0) check_results$SIT04 <- s1t04
  ...
  if (nrow(sit05) > 0) check_results$SIT05 <- s1t05
  ...
  if (nrow(sit06) > 0) check_results$SIT06 <- s1t06
  ...
  if (nrow(sit07) > 0) check_results$SIT07 <- s1t07
  ...
  if (nrow(sit08) > 0) check_results$SIT08 <- s1t08
  ...
  if (nrow(sit09) > 0) check_results$SIT09 <- s1t09
  ...
  if (nrow(sit10) > 0) check_results$SIT10 <- s1t10
  ...
  if (nrow(sit11) > 0) check_results$SIT11 <- s1t11
  ...
  if (nrow(sit12) > 0) check_results$SIT12 <- s1t12
  ...
  if (nrow(sit13) > 0) check_results$SIT13 <- s1t13
  ...
  if (nrow(sit14) > 0) check_results$SIT14 <- s1t14
  ...
  if (clean_NA == TRUE) {
    sit26 <- sit26 |>
      filter(if_all(c("D42", "D43", "D44", "D45"), ~ !is.na(.x)))
  }
  ...
  if (clean_NA == TRUE) {
    sit30 <- sit30 |>
      filter(if_all(c("D74.D","D75.D", "D76.D"), ~ !is.na(.x)))
  }
  ...
  if (clean_NA == TRUE) {
    sit31 <- sit31 |>
      filter(if_all(c("D75"), ~ !is.na(.x)))
  }

  if (nrow(sit31) > 0) check_results$SIT31 <- sit31
  ## SIT32----------------------------------------------------------------------------------------

  needed_sit32 <- c("ref_area", "ref_sector", "time_period", "D7N.D", "D74.C", "D75.C")
  ...
  if (clean_NA == TRUE) {
    sit32 <- sit32 |>
      filter(if_all(c("D74.C", "D75.C"), ~ !is.na(.x)))
  }
