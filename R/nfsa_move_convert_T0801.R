#' Convert SDMX data to Parquet format for NASEC_T0801_Q data.
#'
...
#'   Defaults to "data/q/new/nsa" relative to the project root using `here::here()`.
#'
...
#'   "NASEC_T0801_Q_{country}_{yearquarter}" in the input directory. It identifies the file
...
#'
#' @examples
#' nfsa_move_convert_T0801(country= "BE",
#' yearquarter = "2025_0002",
#' input_sel = "M:/nas/Incoming_SDMX_files/",
#' output_sel = "C:/users/biedmlu/data/q/new/nsa")
nfsa_move_convert_T0801 <- function(country,
                               yearquarter,
                               input_sel = "M:/nas/Incoming_SDMX_files/",
                               output_sel = here("data","q","new","nsa")){
...
if(length(file) ==0) {  print(paste0("No T0801 file for ", country))
  } else {

if (file == files_have){
  print(paste0("No new T0801 file for ", country))
} else{
