...
#' nfsa_revision_T0800_all(country = "IT", "ref_sector == 'S13'")
#'
#' # Example with multiple filters
#' nfsa_revision_T0800_all(country = "IT", "ref_sector == 'S13'", "sto == 'B9'")
#'
...
nfsa_revision_T0800_all <- function(country,
  ...
  lifecycle::deprecate_soft(
    when = "0.2.0",
    what = "nfsa_revision_T0800_all()",
    with = "nfsa_revision_all(table = 'T0800')"
  )
